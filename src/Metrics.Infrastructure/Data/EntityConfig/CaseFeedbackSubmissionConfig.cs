...
public class CaseFeedbackSubmissionConfig : IEntityTypeConfiguration<CaseFeedbackSubmission>
{
    public void Configure(EntityTypeBuilder<CaseFeedbackSubmission> builder)
    {
        builder.ToTable("case_feedback_submissions");
