    ...
    IDepartmentKeyMetricService departmentKeyMetricService) : PageModel
{
    ...
    public List<DetailReport_ViewModel> DetailReport_All { get; set; } = [];


    public class DetailReport_ViewModel
    {
        public DetailReport_KeyIssueDepartmentViewModel KeyIssueDepartmentInfo { get; set; } = null!;
        public DetailReport_CandidateViewModel CandidateInfo { get; set; } = null!;
        public decimal Score { get; set; }
        public string? Comment { get; set; }
    }

    public class DetailReport_KeyIssueDepartmentViewModel
    {
        public string KeyIssueDepartmentName { get; set; } = null!;
        public string KeyTitle { get; set; } = null!;
    }

    public class DetailReport_CandidateViewModel
    {
