...
ALTER TABLE metrics.key_kpi_submissions ADD department_id1 bigint;

ALTER TABLE metrics.key_kpi_submissions ADD department_key_metric_id bigint;

ALTER TABLE metrics.key_kpi_submission_items ALTER COLUMN department_id DROP NOT NULL;
...
CREATE INDEX ix_key_kpi_submissions_department_id1 ON metrics.key_kpi_submissions (department_id1);
...
ALTER TABLE metrics.key_kpi_submission_items ADD CONSTRAINT fk_key_kpi_submission_items_departments_department_id FOREIGN KEY (department_id) REFERENCES metrics.departments (id);
...
ALTER TABLE metrics.key_kpi_submissions ADD CONSTRAINT fk_key_kpi_submissions_departments_department_id1 FOREIGN KEY (department_id1) REFERENCES metrics.departments (id);
...
VALUES ('20250605090306_001_UpdateKeyMetricTable', '9.0.2');
